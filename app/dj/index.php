...
foreach ( $output as $song ) {
	...
	$echoBefore1 = '<strong class="text-gray-dark">' . $songTitleArtist . '(' . $noOfRequests . ')' . '</strong>';
	$echoBefore2 = '<a href="purge.php?' . $querySong . '">REMOVE</a></div></div></div><div class="media text-muted pt-3">';
